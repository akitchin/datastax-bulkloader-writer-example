...
public class JmxBulkLoader {
	...
	public static void main(String[] args) throws Exception {
		...
		File currentDir = new File(".", "/datastax_bulkload_writer_demo/transactions");
		
		jmxBulkLoader.bulkLoad(currentDir.getAbsolutePath());		
		jmxBulkLoader.purgeDirectory(currentDir);
		jmxBulkLoader.close();
	}
}